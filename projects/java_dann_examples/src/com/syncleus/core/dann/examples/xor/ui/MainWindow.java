...
{    ////////////////
    ...
    private final String ICON_PATH = "./icons/";    // default options
...
//		this.selectFileButton = new JButton();
    ...
    private JPanel createOptionSelector()
    {
        ...
        ((JSpinner.DefaultEditor) this.nbCyclesSpin.getEditor()).getTextField().setEditable(false);
...
//			stateTable.setValueAt(synapseWeight, row, 4);
    ...
    public void actionPerformed(ActionEvent evt)
    {
        ...
        if (evt.getSource().equals(this.runButton))
            ...
            { // application was in error state - try to run anyway
                this.setApplicationStatus(3); // set to run training
                if (this.getApplicationStatus() == 3)
                {
                    this.trainButton.setIcon(this.myCancelIcon);
...
//		}
        ...
        {
        case 0:
            this.myStatusText = "Ready. Wating for command.";
            break;
        case 1:
            this.myStatusText = "Running the brain to produce a XOR";
            break;
        case 2:
            this.myStatusText = "Error! No file selected.";
            break;
        case 3:
            this.myStatusText = "Running NN training to learn a XOR";
            break;
        default:
            this.myStatusText = "Unknown.";
        }
