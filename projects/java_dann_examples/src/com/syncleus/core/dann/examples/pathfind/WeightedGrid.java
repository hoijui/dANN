 ...
 * @author seh
 */
public class WeightedGrid extends AbstractBidirectedGraph<GridNode, SimpleWeightedUndirectedEdge<GridNode>, BidirectedWalk<GridNode, SimpleWeightedUndirectedEdge<GridNode>>>
{
